...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Hidemail)`
    : `const run: (${functionSource.client}: Hidemail) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.v1.activateAlias',
    'client.v1.deactivateAlias',
    'client.v1.deleteToken',
    'client.v1.getDomainOptions',
    'client.v1.removeWebhook',
    'client.v1.setWebhook',
    'client.v1.sanctum.createToken',
    'client.v1.email.create',
    'client.v1.aliases.create',
    'client.v1.aliases.list',
    'client.v1.aliases.updateNote',
