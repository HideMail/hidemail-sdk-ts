...
export { ClientOptions } from 'hidemail';
...
export function initMcpServer(params: {
  ...
  const client = new Hidemail(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Hidemail({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
